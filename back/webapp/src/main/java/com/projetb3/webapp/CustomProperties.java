...
@ConfigurationProperties(prefix="com.projetb3.webapp")   //mettre le code en parallele avec application.properties //scannera les proprietes commençant par com.projet.cineman
